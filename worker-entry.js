  ...
  if (pathname === '/' || pathname === '/index.html') {
    rewriter.on('body', {
      element(element) {
        ...
        element.append('<script src="/member-assistant-live.js?v=20260826-4"></script><script src="/member-medication-delete.js?v=20260826-1"></script><script src="/member-reminders-live.js?v=20260826-2"></script><script src="/member-overview-reminders.js?v=20260826-1"></script><script>(()=>{const page=sessionStorage.getItem("aria-return-page");if(page){sessionStorage.removeItem("aria-return-page");const valid=new Set(["dashboard","medications","reminders","carecircle","incidents","privacy"]);if(valid.has(page)&&typeof showPage==="function")showPage(page);}})();</script>', { html: true });
      }
    });
  }
